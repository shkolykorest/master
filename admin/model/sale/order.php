...
class ModelSaleOrder extends Model {
	...
	public function getOrder($order_id) {
		$order_query = $this->db->query("SELECT *, (SELECT CONCAT(c.firstname, ' ', c.lastname) FROM " . DB_PREFIX . "customer c WHERE c.customer_id = o.customer_id) AS customer, (SELECT c.manager_id FROM `" . DB_PREFIX . "customer` c WHERE o.customer_id=c.customer_id) as manager_id FROM `" . DB_PREFIX . "order` o WHERE o.order_id = '" . (int)$order_id . "'");
